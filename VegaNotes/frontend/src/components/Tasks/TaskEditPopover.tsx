          ...
          {editingTitle ? (
            ...
            <div className="flex items-start gap-1.5 mt-0.5">
              ...
              <button
                ...
                className="shrink-0 text-slate-400 hover:text-sky-700 text-sm leading-none py-0.5 px-1"
                title="Edit title"
                aria-label="Edit title"
              >
                ✎
      ...
      {confirmDelete ? (
        ...
        <>
          <button
            type="button"
            onClick={onEdit}
            className="shrink-0 text-slate-400 hover:text-sky-700 leading-none px-1"
            title="Edit this AR"
          ...
          <button
            ...
            className="shrink-0 text-slate-400 hover:text-rose-700 leading-none px-1"
